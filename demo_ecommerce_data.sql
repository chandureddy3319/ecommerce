-- Demo E-commerce SQL Data
-- Creates database, tables, and inserts demo data with online images
...
INSERT IGNORE INTO admins (username, email, password, first_name, last_name) VALUES
('admin', 'admin@ecommerce.com', '$2y$10$wH6QwQnQnQnQnQnQnQnQnOQnQnQnQnQnQnQnQnQnQnQnQnQnQn', 'Admin', 'User');

-- Insert categories with demo images
INSERT IGNORE INTO categories (name, description, icon, image) VALUES
...
-- Insert demo products with online images
INSERT IGNORE INTO products (name, description, price, stock, image, category_id, featured) VALUES
